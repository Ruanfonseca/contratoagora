...
import { z } from 'zod';
import '../css/form.css';
import geradorpdflocacaoveiculopago from '../util/pdf';
    ...
    const handlePayment = async () => {
        ...
        try {
            const response = await api.post('/server/pix', {
                ...
                description: `Contrato de Locação de Veículo`,
                paymentMethodId: "pix",
                payer: {
                    name: "Contrato",
    ...
    return (
        <>
            ...
            <div className="BaixarPdf">
                {isPaymentApproved ? (
                    <button className='btnBaixarPdf' onClick={() => { geradorpdflocacaoveiculopago(formData) }}>
                        Baixar PDF
                    </button>
                ) : (
